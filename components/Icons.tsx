...
export const IconInk = ({ className }: { className?: string }) => (
...
export const IconScissor = ({ className }: { className?: string }) => (
...
export const IconWarehouse = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M6 22V9a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13"/><path d="M10 22V9"/><path d="M14 22V9"/><path d="M22 6h-5v5h5Z"/><path d="M7 6H2v5h5Z"/></svg>
);
